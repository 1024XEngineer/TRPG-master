...
- `ModuleContentV3`: `content_schema_version`, `module_id`, `version`, `world_ref`, `background`, `information`, `knowledge_goals`, `entities`, `locations`, `location_edges`, `rules`, `core_resolution`, `ending_policy`, `ending_anchors`, `presentation`, `initial_state`, `world_profile`, `time_policy`
