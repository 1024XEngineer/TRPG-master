...
| `world` | `ProjectionWorldState` | 场景之外的玩家安全世界事实：`elapsed_minutes`、`time_of_day`、`core_resolved`、`ending_available`、`ending_id` |
...
| `world` | `WorldStateView` | `ProjectionWorldState` 的玩家侧镜像；`advance_time`、`mark_core_resolved`、`set_ending_availability`、`commit_terminal_ending` 这些效果只有经由它才可观测 |
