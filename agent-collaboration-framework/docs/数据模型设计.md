...
当前不承诺 PostgreSQL/SQLAlchemy adapter、数据库迁移、FastAPI 路由、完整 COC7 Reference 层、真实 Dice/RNG、多阶段 Action、interrupt/resume、LangGraph State、SummaryOutbox、真实模型 SDK DTO，以及 C 的 ModuleDraft/ReviewReport 具体字段。
