...
class PublishedModuleRuntimeLoadTests(unittest.TestCase):
    ...
    def test_published_json_loads_into_runtime_and_executes_checkpoint(self) -> None:
        ...
        self.assertTrue(application.engine.snapshot().entities["bookshelf"]["key_found"])
        self.assertEqual(application.engine.snapshot().event_sequence, 1)
    ...
    def test_phase1_published_module_completes_sequential_runtime_flow(self) -> None:
        ...
        investigate_execution = application.engine.execution_for(
        ...
        smash_execution = application.engine.execution_for(
