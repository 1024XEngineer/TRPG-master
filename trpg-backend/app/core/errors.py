...
class ErrorCode(StrEnum):
    ...
    ACTION_IN_PROGRESS = "ACTION_IN_PROGRESS"  # 必须先回答当前检定/确认 → 409
    ACTION_QUEUE_FULL = "ACTION_QUEUE_FULL"  # 主持队列已满（每人最多一条） → 409
    CHARACTER_INCOMPLETE = "CHARACTER_INCOMPLETE"  # 角色卡未建完，无法进行需要角色的操作 → 409
    MODULE_NOT_SELECTED = "MODULE_NOT_SELECTED"  # 房间还没选定模组 → 409
    MODULE_PLAYER_COUNT_MISMATCH = "MODULE_PLAYER_COUNT_MISMATCH"  # 房间人数不符合模组要求 → 409
    ...
    # issue #199：建卡完成后的可选角色生图工作流。
    PORTRAIT_GENERATION_DISABLED = "PORTRAIT_GENERATION_DISABLED"
    PORTRAIT_GENERATION_IN_PROGRESS = "PORTRAIT_GENERATION_IN_PROGRESS"
    PORTRAIT_CONTENT_REJECTED = "PORTRAIT_CONTENT_REJECTED"
    PORTRAIT_GENERATION_FAILED = "PORTRAIT_GENERATION_FAILED"
    PORTRAIT_GENERATION_TIMEOUT = "PORTRAIT_GENERATION_TIMEOUT"
    ...
    ENDING_UNAVAILABLE = "ENDING_UNAVAILABLE"
    ENDING_DRAFT_STALE = "ENDING_DRAFT_STALE"
