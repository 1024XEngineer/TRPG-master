...
CONSTANT_DARKNESS_BOX_SCENARIO_ID = CONSTANT_DARKNESS_BOX_SPEC.scenario_id
CONSTANT_DARKNESS_BOX_MODULE_ID = CONSTANT_DARKNESS_BOX_SPEC.module_id
CONSTANT_DARKNESS_BOX_MODULE_VERSION = CONSTANT_DARKNESS_BOX_SPEC.version
